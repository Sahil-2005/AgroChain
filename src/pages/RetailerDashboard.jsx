...
const RetailerDashboard = () => {
  ...
  // Request form state for distributors/products
  ...
  const handleOpenRequestForm = (distributorIndex, productIndex) => {
    setRequestFormOpen({ [`${distributorIndex}-${productIndex}`]: true });
    setRequestFormData({ [`${distributorIndex}-${productIndex}`]: { quantity: '', price: '', description: '' } });
  };

  const handleCloseRequestForm = (distributorIndex, productIndex) => {
    setRequestFormOpen({ [`${distributorIndex}-${productIndex}`]: false });
  };

  const handleFormChange = (distributorIndex, productIndex, field, value) => {
    setRequestFormData(prev => ({
      ...prev,
      [`${distributorIndex}-${productIndex}`]: {
        ...prev[`${distributorIndex}-${productIndex}`],
        [field]: value
      }
    }));
  };

  const handleSubmitRequest = (distributorIndex, productIndex) => {
    setRequestFormOpen({ [`${distributorIndex}-${productIndex}`]: false });
    setRequestFormData(prev => ({
      ...prev,
      [`${distributorIndex}-${productIndex}`]: { quantity: '', price: '', description: '' }
    }));
  ...
  const renderOverview = () => (
    <div className="space-y-6">
      {/* Key Metrics */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-300 p-6 shadow-md  rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">Partner Distributors</p>
              <p className="text-3xl font-bold">{overviewData.partnerDistributors}</p>
      ...
      {/* Current Inventory Status */}
      <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200 p-6 shadow-mdrounded-lg p-6">
        <h3 className="text-lg font-semibold mb-2 text-purple-700 mb-2">Current Inventory Status</h3>
        <p className="text-gray-600 text-sm mb-4">Overview of your retail inventory</p>
      ...
      {/* Top Selling Products */}
      <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200 p-6 shadow-md rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-2 text-purple-700 mb-2">Top Selling Products</h3>
        <p className="text-gray-600 text-sm mb-4">Best performing products this week</p>
  ...
  const renderDistributors = () => (
    <div className="space-y-6">
      ...
      {distributors.map((distributor, distributorIndex) => (
        <div key={distributorIndex} className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200 p-6 shadow-md rounded-lg p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-4">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center">
                <Truck className="h-4 w-4 text-green-600" />
              ...
              <div>
                <h3 className="font-semibold text-green-700">{distributor.name}</h3>
                <div className="flex flex-wrap items-center space-x-2 text-sm text-gray-600">
                  <MapPin className="h-4 w-4" />
                  <span>{distributor.location}</span>
                  <div className="flex items-center space-x-1">
            ...
            <div className="space-y-3">
              {distributor.products.map((product, productIndex) => (
                <div key={productIndex}>
                  <div className="bg-white rounded-lg p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <p className="font-medium">{product.name}</p>
                      <p className="text-sm text-gray-600">
                        {product.quantity} • {product.price} • From {product.origin}
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                      <button
                        className="flex items-center space-x-1 px-4 py-2 border border-gray-300 rounded-lg text-sm hover:bg-white-50 w-full sm:w-auto"
                        onClick={() => handleOpenRequestForm(distributorIndex, productIndex)}
                      >
                  ...
                  {/* Individual Request Form for each product */}
                  {requestFormOpen[`${distributorIndex}-${productIndex}`] && (
                    <form
                      className="bg-white-200 rounded-lg p-4 mt-2"
                      onSubmit={e => {
                        e.preventDefault();
                        handleSubmitRequest(distributorIndex, productIndex);
                      }}
                    >
                      <div className="mb-3">
                        ...
                        <input
                          type="text"
                          required
                          value={requestFormData[`${distributorIndex}-${productIndex}`]?.quantity || ''}
                          onChange={e => handleFormChange(distributorIndex, productIndex, 'quantity', e.target.value)}
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          type="text"
                          required
                          value={requestFormData[`${distributorIndex}-${productIndex}`]?.price || ''}
                          onChange={e => handleFormChange(distributorIndex, productIndex, 'price', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-green-500"
                      ...
                      <div className="mb-3">
                        ...
                        <textarea
                          value={requestFormData[`${distributorIndex}-${productIndex}`]?.description || ''}
                          onChange={e => handleFormChange(distributorIndex, productIndex, 'description', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-green-500"
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button
                          ...
                          onClick={() => handleCloseRequestForm(distributorIndex, productIndex)}
                        >
                          Cancel
                        </button>
                      </div>
  ...
  const renderInventory = () => (
    <div className="space-y-6">
      {inventoryDetails.map((item, index) => (
        <div key={index} className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200 p-6 shadow-md  rounded-lg p-6">
          <div className="flex items-start justify-between mb-6">
            <div>
  ...
  const renderSales = () => (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200 p-6 shadow-md rounded-lg p-6">
        <div className="flex items-center space-x-2 mb-4">
          <BarChart3 className="h-5 w-5" />
          <span className="font-semibold text-lg text-rose-700">Sales Performance</span>
        </div>
        <p className="text-gray-600 text-sm mb-6">Track your sales metrics and performance</p>
  ...
  return (
    <>
      <div className="min-h-screen bg-white">
        ...
        <div className="px-6 py-8 max-w-7xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-purple-800 mb-2">Retailer Dashboard</h1>
            <p className="text-gray-600">Source products from distributors and manage your retail inventory</p>
          </div>
